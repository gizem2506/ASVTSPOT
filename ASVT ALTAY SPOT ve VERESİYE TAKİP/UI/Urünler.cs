...
namespace ASVT_ALTAY_SPOT_ve_VERESİYE_TAKİP.UI
{
        ...
        private void btnÜrünDüzenle_Click(object sender, EventArgs e)
        {
            ...
            Urun frm = new Urun()
            {
                ...
                Urun = new Urun()
                {
                    ...
                    Ağırlık = double.Parse(row.Cells[4].Value.ToString()),
                    Renk = row.Cells[5].Value.ToString(),
       ...
       //   if (sonuc == DialogResult.OK)
            {
                ...
                if (b)
                {
                    ...
                    row.Cells[4].Value = frm.Urun.Ağırlık;
                    row.Cells[5].Value = frm.Urun.Renk;
